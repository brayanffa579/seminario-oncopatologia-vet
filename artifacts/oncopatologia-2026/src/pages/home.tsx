              ...
              >
                ...
                <div className="flex gap-2 mt-auto pt-2">
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className={`flex items-center justify-center gap-1.5 px-3 py-2 rounded-lg border border-border/70 text-xs font-medium text-muted-foreground hover:border-primary hover:text-primary hover:bg-primary/5 transition-all duration-200 ${hotel.whatsapp ? "flex-1" : "w-full"}`}
                  >
                  ...
                  {hotel.whatsapp && (
                    <a
                      href={`https://wa.me/${hotel.whatsapp}?text=Hola,%20quisiera%20información%20sobre%20disponibilidad%20y%20tarifas`}
                      target="_blank"
                      rel="noopener noreferrer"
                      className="flex-1 flex items-center justify-center gap-1.5 px-3 py-2 rounded-lg text-xs font-medium text-white transition-all duration-200 hover:opacity-90"
